...
foreach($arResult["SECTIONS"] as $key => $arSection){
    ...
    $arUF = $GLOBALS["USER_FIELD_MANAGER"]->GetUserFields("IBLOCK_3_SECTION",$arSection['ID'],"UF_PREVIEW_TEXT");
    if($arUF["UF_PREVIEW_TEXT"]["VALUE"] != ""){
        $arResult["SECTIONS"][$key]["UF_PREVIEW_TEXT"] = $arUF["UF_PREVIEW_TEXT"]["VALUE"];
    }
}
?>